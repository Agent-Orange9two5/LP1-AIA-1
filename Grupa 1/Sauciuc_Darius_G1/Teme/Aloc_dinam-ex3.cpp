...
/*
    ...
    In programul de mai sus se aloca memorie pentru "size" string-uri, iar apoi se realoca memorie pentru "newSize" - "size" string-uri. 
La final se afiseaza pe ecran intregul string, acesta fiind concatenat.
