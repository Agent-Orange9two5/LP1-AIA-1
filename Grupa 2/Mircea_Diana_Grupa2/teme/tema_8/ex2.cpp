#include <iostream>
#include <cstdlib>//lipsea biblioteca
...
int main() {
    ...
    if (arrMalloc == nullptr) {
        std::cout << "Memory allocation failed using malloc!" << std::endl;//lipsea ":"
        return 1;
    }
    ...
    int newSize;
    std::cout << "Enter the new size for reallocation: ";//lipsea ":"
    std::cin >> newSize;


    float *arrRealloc = (float *)realloc(arrMalloc, newSize * sizeof(float));//lipsea "*"
