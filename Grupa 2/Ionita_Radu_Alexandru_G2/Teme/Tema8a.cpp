...
/*
In program vei introduce in consola un numar de tip int, se va aloca pointerul folosind
functia malloc, dupa se utilizeaza functia calloc care este similara ca functia malloc, dar va initializa
memoria alocata cu zero. In variabila newSize(int) se va introduce de la tastatura un numar nou pentru ca
functia realloc sa modifice dimensiunea memoriei deja alocate.
*/
