...
/* Acest program lucreaza asemanator ca cel cu vectori (ex2), doar ca in acesta se folosesc siruri de caractere.
In cod se introduce dela tastatura un numar care va aloca memorie folosind functia malloc,
dupa se va introduce n stringuri (n=size) care vor fi introduse in pointerul arrMalloc.
Dupa se introduce din nou un numar de la tastatura pentu realocarea vectorului
...
Dupa realocare se vor introduce alte n stringuri care vor fi introduse in pointer pentru a ocupa spatiile
libere din pointer dupa realocare. La sfarsit se afiseaza toate numerele din pointer si se elibereaza pointeru din memorie. */
