...
/* Alocam prin malloc un tablou de "size" elemente de tip int in heap.Dupa care folosim functia calloc care
initializeaza memoria alocata cu 0.
Dupa care realocam prin Realloc in heap un tablou de "newSize" elemente*/
